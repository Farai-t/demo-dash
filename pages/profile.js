...
<h1 class="text-4xl px-1 tracking-tighter font-semibold">
Profile
 </h1>
</div>
...
<img class="mb-2 w-20 h-20 rounded-2xl shadow-lg shadow-gray-300" src="https://demos.creative-tim.com/soft-ui-flowbite-pro/images/users/jese-leos-2x.png" alt="Jese portrait" />
<div>
...
<a class="text-sm font-medium text-gray-900" href="/cdn-cgi/l/email-protection#ccbba9aea1adbfb8a9be8caaa0a3bbaea5b8a9e2afa3a1"><span class="__cf_email__" data-cfemail="c0b9afb5b2aea1ada580a6acafb7a2a9b4a5eea3afad">[email&#160;protected]</span></a
                      >
...
<div class="w-full h-2 bg-gray-200 rounded-full">
<div class="h-2 bg-gray-900 rounded-full" style={{width: 55+'%'}}></div>
</div>
</div>
<div>
<div class="mb-1 text-base font-medium text-gray-500">
...
<div class="w-full h-2 bg-gray-200 rounded-full">
<div class="h-2 bg-gray-900 rounded-full" style={{width: 65+'%'}}></div>
</div>
</div>
</div>
<div class="space-y-6">
